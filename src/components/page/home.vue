<template>
    <div class="justify-center homebg">
            ...
            <div class="cardall">
                <el-card class="box-card" v-for="(item, index) in spuList" :key="index">
                    ...
                    <div class="justify-center" style="line-height: 60px;">
                        <span style="font-size: 35px;font-weight:bolder;font-family: 仿宋; color: #43D98E;">{{
                            item.price }}</span>
                    ...
                    <div class="justify-center" style="position: absolute;bottom: 15px;width: 85%">
                        ...
                        <el-button type="primary" style="width: 100%" @click="tobug(item)" v-if="item.isbuy == '1'">{{
                            $t('home.buynow') }}</el-button>
                ...
                <div style="width: 90%">
                    ...
                    <el-form :model="form1" :rules="rules1" ref="ruleForm1">
                        ...
                        <el-form-item prop="num">
                            <el-radio-group v-model="form1.num" style="display: flex;" v-if="spu.type == '2'"
                                @change="updatePrice">
                                ...
                                <el-radio-button :label="spu.maxnum" class="skuname">{{ spu.maxnum }}
                                    {{ $t('home.maxnum') }}</el-radio-button>
                            </el-radio-group>
                        ...
                        <div style="padding-left: 10px;">
                            ...
                            <el-input type="text" v-model="form1.discountcode" :placeholder="$t('home.discountcode')"
                                style="width: 50%;margin-left: 2%" clearable></el-input>
                            ...
                            <el-button type="primary" style="margin-left:3%" @click="useDiscountcode">{{ $t('home.use')
                            }}</el-button>
                        </div>
                        <el-divider></el-divider>
                        <el-form-item style="padding-left: 10px;" prop="paycode">
                            ...
                            <el-select v-model="form1.paycode" :placeholder="$t('home.pleasechoose')"
                                style="margin-left: 5%">
                        ...
                        <div style="padding: 50px 0;">
                            ...
                            <el-button style="width: 100%" type="primary" round @click="soonbug">{{ $t('home.buynow')
                            }}</el-button>
                        </div>
                    </el-form>
                </div>
            ...
            <div style="width: 100%" class="justify-center">
                <div style="width: 90%">
                    ...
                    <div v-if="'' != payaddress && null != payaddress && payaddress.length > 0"
                        ...
                        <el-select :placeholder="$t('home.payaddress')" v-model="addressinfo" @change="changeAddress">
                    ...
                    <el-form :model="form2" :rules="rules2" ref="ruleForm2" label-position="top" size="medium">
                        ...
                        <el-form-item :label="$t('home.country')" prop="country">
                            <el-select v-model="form2.country" :placeholder="$t('home.pleasechoose')" filterable
                        ...
                        <el-form-item :label="$t('home.state')" prop="state">
                            ...
                            <el-select v-model="form2.state" :placeholder="$t('home.pleasechoose')" filterable
                        ...
                        <div style="padding: 50px 0;">
                            ...
                            <el-button style="width: 100%" type="primary" round @click="submitUserInfo">{{ $t('home.submit')
                            }}</el-button>
                        </div>
                    </el-form>
                </div>
                ...
                <div style="width: 90%">
                    ...
                    <el-form :model="form3" :rules="rules3" ref="ruleForm3" size="mini">
                        ...
                        <div style="padding: 50px 0;">
                            ...
                            <el-button style="width: 100%" type="primary" round @click="playorder">{{ $t('home.play') }} ${{
                                price }}</el-button>
                        </div>
                    </el-form>
                </div>
        ...
        <el-drawer class="payssion-drawer" title="상품 정보를 확인해 주십시오" :close-on-press-escape="false" :wrapperClosable="false"
            :visible.sync="drawer5" direction="rtl">
            <div class="darwer-box">
                <el-descriptions class="content-title" :column="1">
                    <el-descriptions-item class="content-item" label="상품명">{{ goodsname }}</el-descriptions-item>
                    <el-descriptions-item class="content-item" label="가격">{{ price }} USD</el-descriptions-item>
                    <el-descriptions-item class="content-item" label="월" :span="2">{{ month }}</el-descriptions-item>
                </el-descriptions>
                <el-form :model="form2" :rules="rules2" ref="ruleForm2" label-position="top" size="medium">
                    <el-form-item :label="$t('home.phone')" prop="phone">
                        <el-input v-model="form2.phone"></el-input>
                ...
                <el-button style="width: 100%" type="primary" round @click="topayssion">{{ $t('home.buynow')
                }}</el-button>
            </div>
        </el-drawer>
...
<script>
import { getGoodsspuAll, calprice, orderSubmit, getCountryinfoAll, getProvinceAll, getPayAddressByUserId, paytypeall, payssion } from "@/request/requests";
...
export default {
    ...
    methods: {
        ...
        async topayssion() {
            ...
            const res = await payssion(params)
        ...
        tobug(spu) {
            this.spu = spu
            this.goodsname = this.spu.goodsname
            this.drawer1 = true
            this.form1 = {
                goodsid: spu.id,
                skuid: spu.skus[0].id,
